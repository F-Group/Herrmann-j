...
<footer id="t3-footer" class="wrap t3-footer">
	...
	<?php if ($this->checkSpotlight('footnav', 'footer-1, footer-2, footer-3, footer-4, footer-5, footer-6')) : ?>
		...
		<!-- //FOOT NAVIGATION -->
	<?php endif ?>
	<section class="our-topic">
		<div class="container">
			<jdoc:include type="modules" name="<?php $this->_p('our-topic') ?>" />
		</div>
	</section>
	<section class="our-service">
		<div class="container">
			<jdoc:include type="modules" name="<?php $this->_p('service-nav') ?>" />
		</div>
	</section>
